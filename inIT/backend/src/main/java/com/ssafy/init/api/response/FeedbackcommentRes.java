...
@Data
@NoArgsConstructor
@ApiModel(value = "FeedbackcommentRes : 피드백 게시글에 대한 댓글 정보 조회 API 요청에 대한 응답값 정의")
public class FeedbackcommentRes {
    ...
    @ApiModelProperty(value = "게시글 작성자가 추천 했는지 여부", example = "false")

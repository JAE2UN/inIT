...
public class MyRestController {
	...
	public ResponseEntity<?> startRecording(@RequestBody Map<String, Object> params) {
		...
		try {
			...
			System.out.println(">>> start recording: url=" + recording.getUrl()); 	//null값이 반환
	...
	public ResponseEntity<?> stopRecording(@RequestBody Map<String, Object> params) {
		...
		System.out.println(">>> stop recording: url(My Ver)=" + "https://interview.ml:4443/openvidu/recordings/" + recordingId + "/" + recordingId + ".mp4");
